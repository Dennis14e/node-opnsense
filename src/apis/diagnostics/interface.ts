...
export class InterfaceClient extends BaseClient {
    ...
    async delRoute (destination, gateway) {
        ...
        return this.httpClient.post('/diagnostics/interface/delRoute', post_data);
    }
     ...
     */
    async flushArp () {
        return this.httpClient.post('/diagnostics/interface/flushArp');
    }
     ...
     */
    async getArp () {
        return this.httpClient.get('/diagnostics/interface/getArp');
    }
    ...
    async getBpfStatistics () {
        return this.httpClient.get('/diagnostics/interface/getBpfStatistics');
    }
    ...
    async getInterfaceNames () {
        return this.httpClient.get('/diagnostics/interface/getInterfaceNames');
    }
    ...
    async getInterfaceStatistics () {
        return this.httpClient.get('/diagnostics/interface/getInterfaceStatistics');
    }
    ...
    async getMemoryStatistics () {
        return this.httpClient.get('/diagnostics/interface/getMemoryStatistics');
    }
     ...
     */
    async getNdp () {
        return this.httpClient.get('/diagnostics/interface/getNdp');
    }
    ...
    async getNetisrStatistics () {
        return this.httpClient.get('/diagnostics/interface/getNetisrStatistics');
    }
    ...
    async getProtocolStatistics () {
        return this.httpClient.get('/diagnostics/interface/getProtocolStatistics');
    }
     ...
     */
    async getRoutes () {
        return this.httpClient.get('/diagnostics/interface/getRoutes');
    }
    ...
    async getSocketStatistics () {
        return this.httpClient.get('/diagnostics/interface/getSocketStatistics');
    }
}
