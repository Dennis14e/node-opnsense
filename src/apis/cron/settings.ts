...
export class SettingsClient extends BaseClient {
     ...
     */
    async addJob () {
        return this.httpClient.post('/cron/settings/addJob');
    }
     ...
     */
    async delJob (uuid) {
        return this.httpClient.post('/cron/settings/delJob/' + uuid);
    }
     ...
     */
    async getJob (uuid = '') {
        return this.httpClient.get('/cron/settings/getJob/' + uuid);
    }
     ...
     */
    async searchJobs () {
        return this.httpClient.get('/cron/settings/searchJobs');
    }
    ...
    async setJob (uuid, job) {
        return this.httpClient.post('/cron/settings/setJob/' + uuid, { job: job });
    }
    ...
    async toggleJob (uuid, enabled = null) {
        ...
        return this.httpClient.post('/cron/settings/toggleJob/' + uuid + '/' + enabled);
    }
}
