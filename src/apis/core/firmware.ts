 ...
 * Firmware
 */
export class FirmwareClient extends BaseClient {
    /**
     * @openapi
     *
     ...
     */
    async poweroff () {
        return this.httpClient.post('/core/firmware/poweroff');
    }
     ...
     */
    async reboot () {
        return this.httpClient.post('/core/firmware/reboot');
    }
     ...
     */
    async running () {
        return this.httpClient.get('/core/firmware/running');
    }
    ...
    async getFirmwareConfig () {
        return this.httpClient.get('/core/firmware/getFirmwareConfig');
    }
    ...
    async getFirmwareOptions () {
        return this.httpClient.get('/core/firmware/getFirmwareOptions');
    }
    ...
    async setFirmwareConfig (mirror = null, flavour = null, type = null, subscription = null) {
        ...
        return this.httpClient.post('/core/firmware/setFirmwareConfig', post_data);
    }
     ...
     */
    async info () {
        return this.httpClient.get('/core/firmware/info');
    }
     ...
     */
    async status () {
        return this.httpClient.get('/core/firmware/status');
    }
     ...
     */
    async health () {
        return this.httpClient.post('/core/firmware/health');
    }
     ...
     */
    async audit () {
        return this.httpClient.post('/core/firmware/audit');
    }
    ...
    async upgrade (upgrade = null) {
        ...
        return this.httpClient.post('/core/firmware/upgrade', post_data);
    }
     ...
     */
    async upgradestatus () {
        return this.httpClient.get('/core/firmware/upgradestatus');
    }
    ...
    async changelog (version) {
        return this.httpClient.post('/core/firmware/changelog/' + version);
    }
    ...
    async install (pkg_name) {
        return this.httpClient.post('/core/firmware/install/' + pkg_name);
    }
    ...
    async reinstall (pkg_name) {
        return this.httpClient.post('/core/firmware/reinstall/' + pkg_name);
    }
    ...
    async installConfiguredPlugins () {
        return this.httpClient.post('/core/firmware/installConfiguredPlugins');
    }
    ...
    async acceptConfiguredPlugins () {
        return this.httpClient.post('/core/firmware/acceptConfiguredPlugins');
    }
    ...
    async remove (pkg_name) {
        return this.httpClient.post('/core/firmware/remove/' + pkg_name);
    }
     ...
     */
    async lock (pkg_name) {
        return this.httpClient.post('/core/firmware/lock/' + pkg_name);
    }
    ...
    async unlock (pkg_name) {
        return this.httpClient.post('/core/firmware/unlock/' + pkg_name);
    }
    ...
    async details (pkg_name) {
        return this.httpClient.post('/core/firmware/details/' + pkg_name);
    }
    ...
    async license (pkg_name) {
        return this.httpClient.post('/core/firmware/license/' + pkg_name);
    }
}
