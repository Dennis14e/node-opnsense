 ...
 * Validations
 */
export class ValidationsClient extends BaseClient {
    /**
     * @openapi
     *
     ...
     */
    async add () {
        return this.httpClient.post('/acmeclient/validations/add');
    }
     ...
     */
    async del (uuid) {
        return this.httpClient.post('/acmeclient/validations/del/' + uuid);
    }
     ...
     */
    async get (uuid = '') {
        return this.httpClient.get('/acmeclient/validations/get/' + uuid);
    }
     ...
     */
    async search () {
        return this.httpClient.get('/acmeclient/validations/search');
    }
    ...
    async toggle (uuid, enabled = null) {
        ...
        return this.httpClient.post('/acmeclient/validations/toggle/' + uuid + '/' + enabled);
    }
     ...
     */
    async update (uuid) {
        return this.httpClient.post('/acmeclient/validations/update/' + uuid);
    }
}
