 ...
 * Actions
 */
export class ActionsClient extends BaseClient {
    /**
     * @openapi
     *
     ...
     */
    async add () {
        return this.httpClient.post('/acmeclient/actions/add');
    }
     ...
     */
    async del (uuid) {
        return this.httpClient.post('/acmeclient/actions/del/' + uuid);
    }
     ...
     */
    async get (uuid = '') {
        return this.httpClient.get('/acmeclient/actions/get/' + uuid);
    }
     ...
     */
    async search () {
        return this.httpClient.get('/acmeclient/actions/search');
    }
    ...
    async sftpGetIdentity () {
        return this.httpClient.get('/acmeclient/actions/sftpGetIdentity');
    }
    ...
    async sftpTestConnection () {
        return this.httpClient.get('/acmeclient/actions/sftpTestConnection');
    }
    ...
    async toggle (uuid, enabled = null) {
        ...
        return this.httpClient.post('/acmeclient/actions/toggle/' + uuid + '/' + enabled);
    }
     ...
     */
    async update (uuid) {
        return this.httpClient.post('/acmeclient/actions/update/' + uuid);
    }
}
